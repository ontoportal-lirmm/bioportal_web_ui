...
class Input::NumberComponent < Input::InputFieldComponent
  ...
  def call
    render Input::InputFieldComponent.new(label: @label, name: @name, value: @value,  placeholder: @placeholder, error_message: @error_message, helper_text: @helper_text, type: "number")
  end
end
