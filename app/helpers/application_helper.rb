...
module ApplicationHelper
  ...
  def ontologies_selector(id:, label: nil, name: nil, selected: nil, placeholder: nil, multiple: true, ontologies: nil)
    content_tag(:div) do
      render(Input::SelectComponent.new(id: id, label: label, name: name, value: ontologies || onts_for_select, multiple: multiple, selected: selected, placeholder: placeholder)) +
