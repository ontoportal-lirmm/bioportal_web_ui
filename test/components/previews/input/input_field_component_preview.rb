...
class Input::InputFieldComponentPreview < ViewComponent::Preview
  ...
  def number(label: "Label", placeholder: "", error_message: "", helper_text: "")
    render Input::NumberComponent.new(label: label, name: "name", placeholder: placeholder, error_message: error_message, helper_text: helper_text)
  end
